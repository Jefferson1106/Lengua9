...
for (var i = 1; i <= 15; i++) {
  ...
  if ($("#" + [i] + "").hasClass("subrayar")) {
    if (caja == "que era de color café" || caja == "que tocan al amanecer" || caja == "que teníamos cuando éramos niños" || caja == "seres que purifican el aire"  || caja == "que hicimos para la clase de Arte" ) {
      respr1 = respr1 + 1;
...
function pregunta2() {
  ...
  for (var i = 16; i <= 36; i++) {
    var caja = $("span[id=" + [i] + "]").text();
    if ($("#" + [i] + "").hasClass("subrayar")) {
      if (caja == "que había sido adquirido recientemente" || caja == "que era muy joven" || caja == "que demostraba un absoluto descuido" || caja == "que no salían de su asombro") {
        respr1 = respr1 + 1;
  ...
  for (var i = 16; i <= 36; i++) {
    var caja = $("span[id=" + [i] + "]").text();
    if (($("#" + [i] + "").hasClass("subrayar")==true) || ($("#" + [i] + "").hasClass("subrayar1")==true)) {
      if (caja == "que estaba mojada" || caja == "que la lluvia había generado" || caja == "que vieron") {
        respr1 = respr1 + 1;
